            ...
            <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12">
                <div class="page-wrapper">
                    <div class="blog-title-area">
                        ...
                        <div class="blog-meta big-meta">
                            <small><a href="single.html"
                                    title="">{{\Carbon\Carbon::parse($article->created_at)->isoFormat('LLLL')}}</a></small>
                            <small><a href="blog-author.html" title="">by {{Auth::user()->name}}</a></small>
                    ...
                    <div class="single-post-media">
                        <img src="upload/menu_08.jpg" alt="Scrolling image" class="img-fluid">
                    </div><!-- end media -->
                    ...
                    <div class="blog-title-area">
                        <div class="tag-cloud-single">
                            <span>Tags</span>
                            @foreach ($article->pivots as $tag)
                            <small class="badge badge-info"><a href="#"
                                    title="">{{$tag->categories->category_name}}</a></small>
                            @endforeach
                        </div><!-- end meta -->
