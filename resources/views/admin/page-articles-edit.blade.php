            ...
            <form action="{{url('/admin/articles/update', $article->id)}}" method="POST" enctype="multipart/form-data"
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="article_title"
                        ...
                        aria-describedby="article-title" autofocus value="{{$article->article_title}} ">
                        ...
                        <div id="kategori" class="col-md-6 form-group typehead">
                            <div class="mb-3">
                                ...
                                <select id="categories" multiple class="form-control" name="category_name[]"
                                    ...
                                    <option value="{{$category->id}}" @foreach ($article->pivots as $item)
                                        @if (in_array($category->id, old('category', [$item->id_categories])))
                                        selected
                                        @endif
                                        @endforeach
                                        >
                ...
                <div class="mb-3">
                    ...
                    <textarea id="summernote" name="article_content">{{$article->article_content}}</textarea>
                        ...
                        <div class="col-6">
                            <div class="mb-3">
                                ...
                                @enderror" id="article-url-video" name="article_url_video"
                                    value="{{$article->article_url_video}}" />
                        ...
                        <div class="col-6">
                            <div class="mb-3">
                                ...
                                <input type="text" name="article_video_embeed" class="form-control @error('article_video_embeed')
                                    is-invalid
                                @enderror" id="article-video-embeed" value="{{$article->article_video_embeed}}" />
