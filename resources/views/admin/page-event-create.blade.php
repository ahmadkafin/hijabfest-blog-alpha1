        ...
        <form action="{{route('events.store')}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group mb-3">
                ...
                <input type="text" id="event-name" name="event_name"
                    ...
                    autofocus value="{{Request::old('event_name')}}" />
            ...
            <div class="form-group mb-3">
                ...
                <input type="text" name="event_desc" class="form-control @error('event_desc') is-invalid @enderror"
                    aria-describedby="event_desc" value="{{Request::old('event_desc')}}">
            ...
            <div class="form-group mb-3">
                ...
                <div class="custom-file">
                    <input type="file" name="event_cover"
                        ...
                        aria-describedby="event_cover" value="{{Request::old('event_cover')}}" id="event-cover">
